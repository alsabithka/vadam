...
export default function IntensityMeter({
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-display text-lg font-bold tracking-wide text-cream drop-shadow">
          {name}
        </span>
        <span className="font-mono text-xs text-cream/70">{pct}%</span>
        {shouting && (
          <span
            className="font-display text-sm font-extrabold text-gold animate-pulse"
